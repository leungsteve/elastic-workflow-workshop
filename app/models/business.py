"""Business models for Negative Review Campaign Detection Workshop."""
...
class BusinessStats(BaseModel):
    """Statistics for a business, used in negative review campaign detection."""
    ...
    is_under_attack: bool = Field(default=False, description="Whether business appears to be under a negative review campaign")
